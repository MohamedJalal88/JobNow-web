...
export const Route = createFileRoute("/contractor/change-password")({
  head: () => ({ meta: [{ title: "Change password — JobNow Contractor" }] }),
...
function ChangePassword() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8">
      <Link to="/contractor/settings" className="inline-flex items-center gap-1 text-sm text-muted-foreground">
      ...
      <div className="mt-5 rounded-3xl bg-card border border-border shadow-soft overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 space-y-5" noValidate>
          ...
          <Button
            id="contractor-change-password-submit"
            type="submit"
