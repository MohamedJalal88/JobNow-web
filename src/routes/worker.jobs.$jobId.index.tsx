...
import {
  ...
  MessageSquare, Phone, Share2, ShieldCheck, Star, Users, Loader2,
} from "lucide-react";
...
function JobDetails() {
  ...
  if (!job) {
    return (
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 text-center">
        ...
        <Link to="/worker/jobs" className="mt-4 inline-flex h-10 px-5 items-center bg-primary text-primary-foreground rounded-full text-sm font-semibold">Back to Jobs</Link>
      </div>
    );
  }
  ...
  return (
    <main className="min-h-dvh bg-muted/40 pb-32 md:pb-12">
      {/* Hero */}
      <header className={`relative text-white bg-gradient-to-br ${skill?.color ?? "from-primary to-primary"}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6 pb-16 md:pb-24">
          <div className="flex items-center justify-between">
            <Link to="/worker/jobs" className="h-10 w-10 rounded-full glass border border-white/20 grid place-items-center">
