...
function WorkerMessages() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-6 md:pt-8">
      ...
      <p className="text-sm text-muted-foreground mt-1">Chat with contractors in real time.</p>
            ...
            {activeChat ? (
              ...
              <div className="h-full flex flex-col items-center justify-center p-8 text-center text-muted-foreground bg-muted/10">
                ...
                <p className="text-sm max-w-sm">
                  Select a contractor from the sidebar or click "Chat" on a job's details page to start chatting.
                </p>
              </div>
            )}
          </section>
